...
Install RayLimit from a local Linux release directory.

Options:
  --package-dir PATH   Release directory to install from (default: parent of this scripts directory)
...
MANIFEST_DEST=$(raylimit_manifest_default_path)
...
raylimit_log "Installing RayLimit $PACKAGE_VERSION for $RAYLIMIT_PLATFORM/$RAYLIMIT_ARCH"
...
raylimit_write_manifest "$MANIFEST_DEST" "$PACKAGE_VERSION"

raylimit_log "Install complete."
