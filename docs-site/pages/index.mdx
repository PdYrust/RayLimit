...
| --- | --- | --- |
| `ip` | runtime-local `all` baseline, specific IP override, specific IP unlimited exception | concrete through direct `tc` attachment |
...
- a runtime-local IP baseline
- a specific IP override
- a specific IP unlimited exception that bypasses the baseline
