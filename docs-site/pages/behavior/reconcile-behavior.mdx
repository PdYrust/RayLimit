...
- a matching baseline class and matching baseline attachment can become `no_op`
...
For IP in particular, this is what keeps specific-IP cleanup from accidentally collapsing the runtime-local baseline.
